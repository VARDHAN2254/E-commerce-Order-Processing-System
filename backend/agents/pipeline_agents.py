...
class OrderAgent:
    def process(self, order_id: str, seed: int, booked_item: Dict[str, object] | None = None) -> OrderData:
        ...
        dummy_orders = {
            ...
            "4": ("Bob Brown", "PulseFit Pro 100", 1, 249.00),
            "5": ("Charlie Blue", "HomeNova Smart 100", 1, 1199.00),
            "6": ("Diana Green", "UrbanCarry Classic 100", 1, 89.00),
            "7": ("Evan White", "NovaBook Air 101", 1, 1699.00),
            "8": ("Fiona Black", "Nova Pro 101", 1, 999.00),
            "9": ("George King", "Aero Street 101", 2, 319.98),
            "10": ("Hannah Lee", "ZenWear Sport 102", 1, 289.00),
        }
